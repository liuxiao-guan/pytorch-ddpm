...
flags.DEFINE_bool('iid', False, help='whether is the iid setting')
flags.DEFINE_float('alpha', 0.7, help='the parameter of the Dirichlet distribution')
flags.DEFINE_integer('min_require', 1, help='the min size of each client data')
# Logging & Sampling
flags.DEFINE_string(
    'logdir', './logs/cifar10_fedavg_noniid_0.7', help='log directory')
...
def train():
    ...
    clients_group = ClientsGroup(
        'cifar10', FLAGS.batch_size, FLAGS.client_num, FLAGS.iid,FLAGS.alpha,FLAGS.min_require,device)
