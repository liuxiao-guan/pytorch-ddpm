            ...
            if args.use_labels:
                ...
                for label in range(args.hhh,args.hhh+2):
                    ...
                    for i in range(10):
                        ...
                        samples = net_sampler(x_T[(label-args.hhh)*5000+i*500:(label-args.hhh)*5000+(i+1)*500], labels=labels).cpu()  # ddim
...
def create_argparser():
    save_dir = 'output_5clients/client0_800e'
    ...
    parser.add_argument("--ckpt_path", default='logs/cifar10_5clients/client0/ckpt_round800.pt', type=str)
